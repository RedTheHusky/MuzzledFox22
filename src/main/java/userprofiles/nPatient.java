...
public class nPatient extends Command implements llMessageHelper, llGlobalHelper, llMemberHelper, rPatient {
    Logger logger = Logger.getLogger(getClass());
    lcGlobalHelper gGlobal;
    String KeyTag ="npatient", gTitle="NSFW Patient",profileName="npatient";
    public nPatient(lcGlobalHelper global){
        String fName="[constructor]";
        logger.info(fName);
        gGlobal=global;
        this.name = "NPatient";
        this.help = "Creating/Displaying your patient record. NSFW edition";
        this.aliases = new String[]{KeyTag,"npatients"};
        this.guildOnly = true;this.category= llCommandCategory_NSFW;
        this.hidden=false;
    }
    public nPatient(lcGlobalHelper global, SlashCommandEvent event){
        String fName="[constructor]";
        logger.info(fName);
        gGlobal=global;
    ...
    protected class runLocal extends upExtensionPatient implements Runnable {
        ...
        public runLocal(CommandEvent ev) {
            ...
            KeyTag ="npatient"; gTitle="NSFW Patient";profileName="npatient";
            launch(gGlobal,ev);
        }
        ...
        public void run() {
            ...
            try {
                gBasicFeatureControl=new lcBasicFeatureControl(gGuild,"npatient",gGlobal);
    ...
    public nPatient(lcGlobalHelper global, Guild guild, User user,String command){

...
public class nfursona extends Command implements llMessageHelper, llGlobalHelper, llMemberHelper, rFursona {
    Logger logger = Logger.getLogger(getClass());
    lcGlobalHelper gGlobal;
    String KeyTag ="nfursona", gTitle="NSFW Fursona",profileName="nfursona";
    public nfursona(lcGlobalHelper global){
        String fName="[constructor]";
        logger.info(fName);
        gGlobal=global;
        this.name = "NFursona";
        this.help = "Creating/Displaying your fursona. NSFW edition";
        this.aliases = new String[]{KeyTag,"nfursonas"};
        this.guildOnly = true;this.category= llCommandCategory_NSFW;
        this.hidden=false;
    }
    public nfursona(lcGlobalHelper global, SlashCommandEvent event){
        String fName="[constructor]";
        logger.info(fName);
        gGlobal=global;
    ...
    protected class runLocal extends upExtensionFursona implements Runnable {
        ...
        public runLocal(CommandEvent ev) {
            ...
            KeyTag ="nfursona"; gTitle="NSFW Fursona";profileName="nfursona";
            launch(gGlobal,ev);
        }
        ...
        public void run() {
            ...
            try {
                gBasicFeatureControl=new lcBasicFeatureControl(gGuild,"nfursona",gGlobal);
    ...
    public nfursona(lcGlobalHelper global, Guild guild, User user,String command){

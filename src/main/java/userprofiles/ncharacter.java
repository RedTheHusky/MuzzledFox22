...
public class ncharacter extends Command implements llMessageHelper, llGlobalHelper, llMemberHelper, rCharacter {
    Logger logger = Logger.getLogger(getClass());
    lcGlobalHelper gGlobal;
    String KeyTag ="ncharacter", gTitle="NSFW Character",profileName="ncharacters";
    public ncharacter(lcGlobalHelper global){
        String fName="[constructor]";
        logger.info(fName);
        gGlobal=global;
        this.name = "NCharacter";
        this.help = "Creating/Displaying your character(s). NSFW edition";
        this.aliases = new String[]{KeyTag,"ncharacters"};
        this.guildOnly = true;this.category= llCommandCategory_NSFW;
        this.hidden=false;
    }
    public ncharacter(lcGlobalHelper global, SlashCommandEvent event){
        String fName="[constructor]";
        logger.info(fName);
        gGlobal=global;
    ...
    protected class runLocal extends upExtensionCharacter implements Runnable {
        ...
        public runLocal(CommandEvent ev) {
            ...
            KeyTag ="ncharacter";gTitle="NSFW  Character";profileName="ncharacters";
            launch(gGlobal,ev);
        }
        ...
        public void run() {
            ...
            try {
                gBasicFeatureControl=new lcBasicFeatureControl(gGuild,"ncharacter",gGlobal);
    ...
    public ncharacter(lcGlobalHelper global, Guild guild, User user,String command){
        logger.info(".run build");

...
public class usersona extends Command implements llMessageHelper, llGlobalHelper, llMemberHelper, rUsersona {
    Logger logger = Logger.getLogger(getClass());
    lcGlobalHelper gGlobal;
    String KeyTag ="membersona", gTitle="Member Profile",profileName="usersona";
    public usersona(lcGlobalHelper global){
        String fName="[constructor]";
        logger.info(fName);
        gGlobal=global;
        this.name = "Member Profile";
        this.help = "Creating/Displaying your member profile. SFW edition";
        this.aliases = new String[]{KeyTag,"usersona"};
    ...
    protected class runLocal implements Runnable {
        ...
        public void run() {
            ...
            try {
                gBasicFeatureControl=new lcBasicFeatureControl(gGuild,"usersona",gGlobal);
        ...
        private void help( String command) {
            ...
            embed.addField("IMPORTANT","This is the SFW profile!!!",false);
        ...
        private void edit() {
            ...
            //character=gUserProfile.jsonUser;
            menuMain(true);
        }
        ...
        private void saveCharacter(){
            ...
            logger.info(fName);
            if(character!=null){
               gUserProfile.jsonUser=character;
            }
        }
        private void loadCharacter(){
            ...
            logger.info(fName);
            if(character==null){
                character=iSafetyCreateCharacter(new JSONObject());
            }else{
                character=iSafetyCreateCharacter(character);
            }
        }*/
    ...
    public usersona(lcGlobalHelper global, Guild guild, User user,String command){

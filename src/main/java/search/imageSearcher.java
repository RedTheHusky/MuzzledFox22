...
public class imageSearcher extends Command implements llMessageHelper, llGlobalHelper, llMemberHelper {
    Logger logger = Logger.getLogger(getClass());
    lcGlobalHelper gGlobal;
    String gTitle="commandImageSearcher",gCommand="imagesearch";
    User gUser;
    Member gMember;
    Guild gGuild;
    TextChannel gTextChannel;
    public imageSearcher(lcGlobalHelper global){
        String fName="[constructor]";
        logger.info(fName);
        gGlobal=global;
        this.name = gTitle;
        this.help = "Get images from web";
        this.aliases = new String[]{gCommand};
        this.guildOnly = true;this.category= llCommandCategory_Between;
        this.hidden=true;
    }
    public imageSearcher(lcGlobalHelper global, SlashCommandEvent event){
        String fName="[constructor]";
        logger.info(fName);
        gGlobal=global;
    ...
    protected class runLocal implements Runnable {
        ...
        public void run() {
            ...
            try {
                gBasicFeatureControl=new lcBasicFeatureControl(gGuild,"commandImageSearcher",gGlobal);
                gBasicFeatureControl.initProfile();
                String[] items;
                boolean isInvalidCommand = true;

                if(gCommandEvent!=null){
        ...
        private void help( String command) {
            ...
            embedBuilder.setDescription("(%WIP%)");

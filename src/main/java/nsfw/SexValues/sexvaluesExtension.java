...
import nsfw.chastity.lockedmen.cLockedmenHomepage;
...
public class sexvaluesExtension {
    ...
    public sexvaluesUserProfile gUserProfile=new sexvaluesUserProfile();
    ...
    public Boolean getProfile(Member member){
        ...
        if(gUserProfile!=null&&gUserProfile.getMember()==member&&gUserProfile.gUserProfile.isProfile()){
            logger.info(fName + ".same member>skip");
            logger.info(fName + ".json="+gUserProfile.gUserProfile.jsonObject.toString());
            return true;
        }
        if(gUserProfile.build(global,member)){
            logger.info(fName + ".json="+gUserProfile.gUserProfile.jsonObject.toString());
            return true;
        }
        return false;
    ...
    public Boolean saveProfile(){
        ...
        logger.info(fName);
        boolean result=gUserProfile.saveProfile();

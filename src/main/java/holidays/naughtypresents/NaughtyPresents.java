    ...
    protected class runLocal extends naughtyPresentsExt implements Runnable {
        ...
        public void run() {
            ...
            try{
                ...
                logger.error(".exception:" + Arrays.toString(ex.getStackTrace()));llSendQuickEmbedMessage(gTextChannel,gTitle,"Exception:"+ex, llColorRed); }
        ...
        private void doEvent(entity4NaughtyPresents.Event event){
            String fName="[doEvent]";
            try{
                EmbedBuilder embed=new EmbedBuilder();
                embed.setTitle(gTitle).setColor(llColorRed_Chili);
        ...
        private void doEventDM(int index){
            String fName="[doEventDM]";
            try{
                EmbedBuilder embed=new EmbedBuilder();
                embed.setTitle(gTitle).setColor(llColorRed_Chili);
        ...
        private void doEventDM(entity4NaughtyPresents.Event event){
            String fName="[doEvent]";
            try{
                EmbedBuilder embed=new EmbedBuilder();
                embed.setTitle(gTitle).setColor(llColorRed_Chili);

...
public class AgeVerified extends Command implements iAgeVerified,llMessageHelper, llGlobalHelper,  llMemberHelper, llNetworkHelper {
        Logger logger = Logger.getLogger(getClass());

        lcGlobalHelper gGlobal;
        String gTitle="AgeVerified[WIP]",gCommand="ageverified";
        Logger loggerReq = Logger.getLogger(CrunchifyLog4jLevel.LovenseReq_STR);
    public AgeVerified(lcGlobalHelper global){
    ...
    public AgeVerified(lcGlobalHelper global, Response response, Member member, TextChannel textChannel, String command){
        String fName="[constructor]";
        logger.info(fName);
        gGlobal=global;
    ...
    public AgeVerified(lcGlobalHelper global, SlashCommandEvent ev){
        String fName="[constructor]";
        logger.info(fName);
        gGlobal=global;
...
protected class runLocal implements Runnable {
    ...
    public void run() {
        ...
        try{
            gBasicFeatureControl=new lcBasicFeatureControl(gGuild,"AgeVerified",gGlobal);
    ...
    boolean isMenu=false;int menuLevel=-1;
    ...
    private void menuMain(Message message){
    ...
    private boolean readFile() {
        ...
        try {
            ...
            try {
                if(text2Json.jsonObject.has(llCommonKeys.keyGuilds)&&!text2Json.jsonObject.isNull(llCommonKeys.keyGuilds)){
                    if(text2Json.jsonObject.getJSONObject(llCommonKeys.keyGuilds).has(gGuild.getId())&&!text2Json.jsonObject.getJSONObject(llCommonKeys.keyGuilds).isNull(gGuild.getId())){

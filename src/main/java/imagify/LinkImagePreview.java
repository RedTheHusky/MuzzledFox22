...
public class LinkImagePreview extends Command implements llMessageHelper, llGlobalHelper, llMemberHelper {
    ...
    Logger logger = Logger.getLogger(getClass()); String cName="[LinkImagePreview]";
    ...
    protected class runLocal implements Runnable {
        ...
        public runLocal(CommandEvent ev) {
            ...
            gEvent = ev;
            gUser = gEvent.getAuthor();logger.info(fName + ".gUser:" + gUser.getId() + "|" + gUser.getName());
        ...
        private void setEnabled(boolean value) {
            ...
            try {
               ...
               gProfile.isUpdated=true;
                ...
                logger.error(fName + ".exception=" + e+" StackTrace:" + Arrays.toString(e.getStackTrace()));
                lsMessageHelper.lsSendQuickErrorEmbedMessageResponse(gTextChannel,gTitle,e.getMessage());
            }
        }

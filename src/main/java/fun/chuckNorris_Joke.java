...
public class chuckNorris_Joke extends Command implements llMessageHelper, llGlobalHelper, llMemberHelper {
    ...
    Logger logger = Logger.getLogger(getClass()); String cName="[chuckNorris_Joke]",gCommand="cnjoke";
    lcGlobalHelper gGlobal;
    public chuckNorris_Joke(lcGlobalHelper global){
        String fName="[constructor]";
        logger.info(cName+fName);
        gGlobal=global;
        this.name = "ChuckNorris_Joke";
    ...
    protected class runLocal implements Runnable {
        ...
        public void run() {
            ...
            try {
                gBasicFeatureControl=new lcBasicFeatureControl(gGuild,"chuckNorris_Joke",gGlobal);

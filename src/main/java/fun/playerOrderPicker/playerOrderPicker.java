...
public class playerOrderPicker extends Command implements llGlobalHelper{
    Logger logger = Logger.getLogger(getClass()); String cName="[PlayerOrderPicker]";
    lcGlobalHelper gGlobal;
    String gTitle="Player Order Picker",gCommand="playerorderpicker";

    public playerOrderPicker(lcGlobalHelper global){
    ...
    protected class runLocal implements Runnable {
        ...
        public void run() {
            ...
            try {
                gBasicFeatureControl=new lcBasicFeatureControl(gGuild,"playerorderpicker",gGlobal);

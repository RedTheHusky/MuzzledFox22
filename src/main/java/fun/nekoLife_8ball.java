...
public class nekoLife_8ball extends Command implements llMessageHelper, llGlobalHelper, llMemberHelper {
    String gUrl="https://nekos.life/api/v2/8ball";
    Logger logger = Logger.getLogger(getClass()); String cName="[8ball]",gCommand="8ball",gTitle="8ball-Fun";
    lcGlobalHelper gGlobal;
    public nekoLife_8ball(lcGlobalHelper global){
        String fName="[constructor]";
        logger.info(cName+fName);
        gGlobal=global;
        this.name = gTitle;
        this.help = "Talk to the 8ball at https://nekos.life/";
    ...
    protected class runLocal extends aBasicCommandHandler implements Runnable {
        ...
        public void run() {
            ...
            try {
                buildBasicFeatureControl(gGlobal,logger,"nekoLife_8ball",gEvent);
                ...
                if(gEvent.getArgs().isEmpty()){
                    ...
                    else {get8Ball();isInvalidCommand=false;}
                }else {
                    ...
                    if(!checkIfMemberIsAllowed()){
                        ...
                        get8Ball();isInvalidCommand=false;
                    }
                }
        ...
        private void help( String command) {
            ...
            embed.addField("Get the ball","Type `"+quickSummonWithSpace+"get`",false);
        ...
        private void get8Ball() {
            String fName = "[get8Ball]";
            ...
            a.get(url)
                    ...
                    .ifSuccess(response -> {
                        ...
                        try {
                            ...
                            String str=object.getString("response");

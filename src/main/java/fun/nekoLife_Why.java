...
public class nekoLife_Why extends Command implements llMessageHelper, llGlobalHelper, llMemberHelper {
    ...
    Logger logger = Logger.getLogger(getClass()); String cName="[Why]",gCommand="why";
    lcGlobalHelper gGlobal;
    public nekoLife_Why(lcGlobalHelper global){
    ...
    protected class runLocal implements Runnable {
        ...
        public void run() {
            ...
            try {
                gBasicFeatureControl=new lcBasicFeatureControl(gGuild,"nekoLife_why",gGlobal);

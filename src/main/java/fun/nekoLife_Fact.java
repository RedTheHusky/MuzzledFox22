...
public class nekoLife_Fact extends Command implements llMessageHelper, llGlobalHelper, llMemberHelper {
    ...
    Logger logger = Logger.getLogger(getClass()); String cName="[fact]",gCommand="fact";
    lcGlobalHelper gGlobal;
    public nekoLife_Fact(lcGlobalHelper global){
    ...
    protected class runLocal implements Runnable {
        ...
        public void run() {
            ...
            try {
                gBasicFeatureControl=new lcBasicFeatureControl(gGuild,"nekoLife_Fact",gGlobal);

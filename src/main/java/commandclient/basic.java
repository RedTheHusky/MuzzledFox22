...
import models.la.laMessageHelper;
...
public class basic extends Command implements llMessageHelper, llGlobalHelper, llMemberHelper {
    ...
    public basic(lcGlobalHelper global){
